...
nests_per_year <- nest_data_with_threat_data_7d_ %>%
  ...
  pivot_wider(
    ...
    values_from = n_nests,
    values_fill = 0) %>%
  rename_with(~ ifelse(.x %in% names(region_names), region_names[.x], .x))
...
pred.fundays <- 
 ...
 ggplot(pred.fundays, 
  ...
  scale_x_continuous(
    breaks = c(0, 5, 10, 15, 20, 25),  # keep your markers
...
nest_survival_reals_status_table <- nest_survival_reals_status %>%
  mutate(
    ...
    status = dplyr::recode(status, "N" = "Unmanaged", "Y" = "Managed"),
     Hatching_rate = (estimate ^ 28) * 100,
    lcl_hatch_rate = (lcl ^ 28) * 100,
    ucl_hatch_rate = (ucl ^ 28) * 100)
...
nest_survival_reals_status_table %>%
  ...
  cols_label(
    ...
    estimate = "Daily nest survival",
    se = "Standard error",
    lcl = "Lower 95% CI",
    ucl = "Upper 95% CI",
    Hatching_rate = "Hatching rate (%)") %>%
  fmt_number(
    columns = c(estimate, se, lcl, ucl),
    decimals = 3,
    use_seps = FALSE) %>%
  fmt_number(
  ...
  cols_align(
    align = "center",
    columns = vars(estimate, se, lcl, ucl, Hatching_rate) ) %>%
  tab_options(
...
funday_mgmt_l_vcv <- 
  MP_chicks_Phi_run[[14]]$results$beta.vcv

funday_mgmt_l_betas <- 
  MP_chicks_Phi_run[[14]]$results$beta
...
ggplot(pred_df %>% 
         filter(mgmt_l != 2), 
       aes(x = funday, y = mean, color = factor(mgmt_l), fill = factor(mgmt_l))) +
  geom_line(size = 1) +
...
# Extract estimates of survival from top models
BC_Chick_dot_surv <- BC_chicks_Phi_run[[13]]$results$real
BC_Chick_hatch_date_x_mgmt_s_surv <- BC_chicks_Phi_run[[11]]$results$real
BC_Chick_quadage_surv <- BC_chicks_Phi_run[[23]]$results$real
BC_Chick_hatch_date_surv <- BC_chicks_Phi_run[[8]]$results$real
BC_Chick_mgmt_s_surv <- BC_chicks_Phi_run[[15]]$results$real
BC_Chick_mgmt_l_surv <- BC_chicks_Phi_run[[14]]$results$real
BC_Chick_mgmt_s_x_quadage_surv <- BC_chicks_Phi_run[[20]]$results$real
BC_Chick_mgmt_s_quadage_surv <- BC_chicks_Phi_run[[17]]$results$real
BC_Chick_mgmt_l_quadage_surv <- BC_chicks_Phi_run[[16]]$results$real
...
BC_Chick_dot_surv$mgmt_s <- unlist(substr(BC_Chick_dot_surv$X2, 11, 11))

Groups <- data.frame(str_split_fixed(rownames(BC_Chick_quadage_surv), " ", n = 5))
BC_Chick_quadage_surv <- cbind(Groups, BC_Chick_quadage_surv)
BC_Chick_quadage_surv$season <- unlist(substr(BC_Chick_quadage_surv$X2, 2, 7))
BC_Chick_quadage_surv$age <- as.numeric(sub("^a", "", BC_Chick_quadage_surv$X4))
BC_Chick_quadage_surv$mgmt_s <- unlist(substr(BC_Chick_quadage_surv$X2, 11, 11))

Groups <- data.frame(str_split_fixed(rownames(BC_Chick_hatch_date_surv), " ", n = 5))
BC_Chick_hatch_date_surv <- cbind(Groups, BC_Chick_hatch_date_surv)
BC_Chick_hatch_date_surv$season <- unlist(substr(BC_Chick_hatch_date_surv$X2, 2, 7))
BC_Chick_hatch_date_surv$age <- as.numeric(sub("^a", "", BC_Chick_hatch_date_surv$X4))
BC_Chick_hatch_date_surv$mgmt_s <- unlist(substr(BC_Chick_hatch_date_surv$X2, 11, 11))

Groups <- data.frame(str_split_fixed(rownames(BC_Chick_mgmt_s_surv), " ", n = 5))
BC_Chick_mgmt_s_surv <- cbind(Groups, BC_Chick_mgmt_s_surv)
BC_Chick_mgmt_s_surv$season <- unlist(substr(BC_Chick_mgmt_s_surv$X2, 2, 7))
BC_Chick_mgmt_s_surv$age <- as.numeric(sub("^a", "", BC_Chick_mgmt_s_surv$X4))
BC_Chick_mgmt_s_surv$mgmt_s <- unlist(substr(BC_Chick_mgmt_s_surv$X2, 11, 11))

Groups <- data.frame(str_split_fixed(rownames(BC_Chick_mgmt_l_surv), " ", n = 5))
BC_Chick_mgmt_l_surv <- cbind(Groups, BC_Chick_mgmt_l_surv)
BC_Chick_mgmt_l_surv$season <- unlist(substr(BC_Chick_mgmt_l_surv$X2, 2, 7))
BC_Chick_mgmt_l_surv$age <- as.numeric(sub("^a", "", BC_Chick_mgmt_l_surv$X4))
BC_Chick_mgmt_l_surv$mgmt_l <- unlist(substr(BC_Chick_mgmt_l_surv$X2, 10, 10))

Groups <- data.frame(str_split_fixed(rownames(BC_Chick_mgmt_s_quadage_surv), " ", n = 5))
BC_Chick_mgmt_s_quadage_surv <- cbind(Groups, BC_Chick_mgmt_s_quadage_surv)
BC_Chick_mgmt_s_quadage_surv$season <- unlist(substr(BC_Chick_mgmt_s_quadage_surv$X2, 2, 7))
BC_Chick_mgmt_s_quadage_surv$age <- as.numeric(sub("^a", "", BC_Chick_mgmt_s_quadage_surv$X4))
BC_Chick_mgmt_s_quadage_surv$mgmt_s <- unlist(substr(BC_Chick_mgmt_s_quadage_surv$X2, 11, 11))

Groups <- data.frame(str_split_fixed(rownames(BC_Chick_mgmt_s_x_quadage_surv), " ", n = 5))
BC_Chick_mgmt_s_x_quadage_surv <- cbind(Groups, BC_Chick_mgmt_s_x_quadage_surv)
BC_Chick_mgmt_s_x_quadage_surv$season <- unlist(substr(BC_Chick_mgmt_s_x_quadage_surv$X2, 2, 7))
BC_Chick_mgmt_s_x_quadage_surv$age <- as.numeric(sub("^a", "", BC_Chick_mgmt_s_x_quadage_surv$X4))
BC_Chick_mgmt_s_x_quadage_surv$mgmt_s <- unlist(substr(BC_Chick_mgmt_s_x_quadage_surv$X2, 11, 11))

Groups <- data.frame(str_split_fixed(rownames(BC_Chick_mgmt_l_quadage_surv), " ", n = 5))
BC_Chick_mgmt_l_quadage_surv <- cbind(Groups, BC_Chick_mgmt_l_quadage_surv)
BC_Chick_mgmt_l_quadage_surv$season <- unlist(substr(BC_Chick_mgmt_l_quadage_surv$X2, 2, 7))
BC_Chick_mgmt_l_quadage_surv$age <- as.numeric(sub("^a", "", BC_Chick_mgmt_l_quadage_surv$X4))
BC_Chick_mgmt_l_quadage_surv$mgmt_l <- unlist(substr(BC_Chick_mgmt_l_quadage_surv$X2, 10, 10))

# constant survival
ggplot() +
  geom_line(data = BC_Chick_dot_surv, aes(x = age, y = estimate, color = as.numeric(season), group = season)) +
  geom_ribbon(data = BC_Chick_dot_surv, aes(x = age, ymin = lcl, ymax = ucl, fill = as.numeric(season), group = season), alpha = 0.2) +
  scale_color_gradient(
    low = "black",
    high = "red",
    name = "season"
...
# quadratic age-dependent survival
ggplot() +
  geom_line(data = filter(BC_Chick_quadage_surv, X1 == "Phi"), 
            aes(x = age, y = estimate)) +
  geom_ribbon(data = filter(BC_Chick_quadage_surv, X1 == "Phi"), 
              aes(x = age, ymin = lcl, ymax = ucl), alpha = 0.2) +
  ylab("daily brood survival (± 95% CI)") +
  xlab("brood age (days)")
...
# quadratic age-dependent survival and management status
ggplot() +
  geom_line(data = filter(BC_Chick_mgmt_s_quadage_surv, X1 == "Phi"), 
            aes(x = age, y = estimate, color = mgmt_s)) +
  geom_ribbon(data = filter(BC_Chick_mgmt_s_quadage_surv, X1 == "Phi"), 
              aes(x = age, ymin = lcl, ymax = ucl, fill = mgmt_s), alpha = 0.2) +
  ylab("daily brood survival (± 95% CI)") +
  xlab("brood age (days)")
...
# quadratic age-dependent survival and management level
ggplot() +
  geom_line(data = filter(BC_Chick_mgmt_l_quadage_surv, X1 == "Phi"), 
            aes(x = age, y = estimate, color = mgmt_l)) +
  geom_ribbon(data = filter(BC_Chick_mgmt_l_quadage_surv, X1 == "Phi"), 
              aes(x = age, ymin = lcl, ymax = ucl, fill = mgmt_l), alpha = 0.2) +
  ylab("daily brood survival (± 95% CI)") +
  xlab("brood age (days)")
...
# quadratic age-dependent survival and management status
ggplot() +
  geom_line(data = filter(BC_Chick_mgmt_s_x_quadage_surv, X1 == "Phi"), 
            aes(x = age, y = estimate, color = mgmt_s)) +
  geom_ribbon(data = filter(BC_Chick_mgmt_s_x_quadage_surv, X1 == "Phi"), 
              aes(x = age, ymin = lcl, ymax = ucl, fill = mgmt_s), alpha = 0.2) +
  ylab("daily brood survival (± 95% CI)") +
  xlab("brood age (days)")
...
# management status-dependent survival
ggplot() +
  geom_point(data = filter(BC_Chick_mgmt_s_surv, X1 == "Phi"), 
            aes(x = mgmt_s, y = estimate, color = mgmt_s)) +
  geom_errorbar(data = filter(BC_Chick_mgmt_s_surv, X1 == "Phi"), 
              aes(x = mgmt_s, ymin = lcl, ymax = ucl, color = mgmt_s)) +
  ylab("daily brood survival (± 95% CI)") +
  xlab("managed?") +
  scale_y_continuous(limits = c(0, 1))
...
# management level-dependent survival
ggplot() +
  geom_point(data = filter(BC_Chick_mgmt_l_surv, X1 == "Phi"), 
            aes(x = mgmt_l, y = estimate, color = mgmt_l)) +
  geom_errorbar(data = filter(BC_Chick_mgmt_l_surv, X1 == "Phi"), 
              aes(x = mgmt_l, ymin = lcl, ymax = ucl, color = mgmt_l)) +
  ylab("daily brood survival (± 95% CI)") +
  xlab("Managed?") +
  scale_y_continuous(limits = c(0, 1))
...
filter(BC_Chick_dot_surv, X1 == "Phi") %>% 
  mutate(fledgling_success = estimate^35)
...
# constant survival
ggplot() +
  geom_line(data = BSC_Chick_dot_surv, aes(x = age, y = estimate, color = as.numeric(season), group = season)) +
  geom_ribbon(data = BSC_Chick_dot_surv, aes(x = age, ymin = lcl, ymax = ucl, fill = as.numeric(season), group = season), alpha = 0.2) +
  scale_color_gradient(
    low = "black",
    high = "red",
    name = "season"
...
# quadratic age-dependent survival
ggplot() +
  geom_line(data = filter(BSC_Chick_quadage_surv, X1 == "Phi"), 
            aes(x = age, y = estimate)) +
  geom_ribbon(data = filter(BSC_Chick_quadage_surv, X1 == "Phi"), 
              aes(x = age, ymin = lcl, ymax = ucl), alpha = 0.2) +
  ylab("Daily brood survival (± 95% CI)") +
  xlab("Brood age (days)")
...
# quadratic age-dependent survival and management status
ggplot() +
  geom_line(data = filter(BSC_Chick_mgmt_s_quadage_surv, X1 == "Phi"), 
            aes(x = age, y = estimate, color = mgmt_s)) +
  geom_ribbon(data = filter(BSC_Chick_mgmt_s_quadage_surv, X1 == "Phi"), 
              aes(x = age, ymin = lcl, ymax = ucl, fill = mgmt_s), alpha = 0.2) +
  ylab("daily brood survival (± 95% CI)") +
  xlab("brood age (days)")
...
# quadratic age-dependent survival and management level
ggplot() +
  geom_line(data = filter(BSC_Chick_mgmt_l_quadage_surv, X1 == "Phi"), 
            aes(x = age, y = estimate, color = mgmt_l)) +
  geom_ribbon(data = filter(BSC_Chick_mgmt_l_quadage_surv, X1 == "Phi"), 
              aes(x = age, ymin = lcl, ymax = ucl, fill = mgmt_l), alpha = 0.2) +
  ylab("Daily brood survival (± 95% CI)") +
  xlab("Brood age (days)")
