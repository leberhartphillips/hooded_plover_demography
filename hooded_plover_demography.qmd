...
```{r}
nest_survival_FP <- readRDS(file = "output/nest_survival_FP_threats&status_200825.rds")
...
nest_survival_MP <- readRDS(file = "output/nest_survival_MP_threats&status_200825.rds")
...
nest_survival_BSC <- readRDS(file = "output/nest_survival_BSC_threats&status_200825.rds")
