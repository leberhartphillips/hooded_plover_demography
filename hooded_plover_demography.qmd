...
This function imports the HOPL chick resighting data stored as Excel sheets into R, wrangles it into a single dataframe, and prepares it for subsequent analysis (e.g., specifies relevant date columns, etc.)
...
hatch_dates_BSC_MP_FP <- 
  ...
  filter(Fate == 0) %>% 
  mutate(hatch_date = ifelse(Fate == 0 & !is.na(clutch_comp), clutch_comp + 35, 
                              ifelse(Fate == 0 & is.na(clutch_comp) & !is.na(chick_1st_ob) & !is.na(state_1st_ob),
                                     ifelse(state_1st_ob == "1/3 adult size, fluffy", chick_1st_ob - 3,
                                            ifelse(state_1st_ob == "1/2 adult size, fluffy", chick_1st_ob - 10,
                                                   ifelse(state_1st_ob == "2/3 adult size, fluffy", chick_1st_ob - 19,
